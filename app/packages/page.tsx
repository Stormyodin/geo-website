...
export default function PackagesPage() {
  ...
  return (
    <main className="min-h-screen">
      <section className="relative pt-32 pb-20 bg-[hsl(var(--ocean))]">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
          <span className="text-white/70 text-sm uppercase tracking-[0.2em] mb-4 block">Explore Our</span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">Island Adventures</h1>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm border transition-colors ${
                selectedCategory === cat.value
                  ? "bg-[hsl(var(--ocean))] text-white border-[hsl(var(--ocean))]"
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/" className="text-[hsl(var(--ocean))] underline text-sm">
              Back to Home
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPackages.map((pkg) => (
              <article key={pkg.id} className="group overflow-hidden border border-[hsl(var(--border))] rounded-2xl bg-[hsl(var(--card))]">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    <Link
                      ...
                      className="flex-1 inline-flex justify-center items-center rounded-md bg-[hsl(var(--ocean))] hover:bg-[hsl(var(--ocean-light))] text-white px-4 py-2 text-sm"
                    >
                      Book
                    </Link>
                    <Link
                      href="/discover-pei"
                      className="inline-flex justify-center items-center rounded-md border border-[hsl(var(--border))] hover:border-[hsl(var(--ocean))] text-sm px-4 py-2"
                    >
                      Learn
                    </Link>
                  </div>
